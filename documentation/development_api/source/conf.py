...
# -*- coding: utf-8 -*-
#
# Shelter-database documentation build configuration file, created by
# sphinx-quickstart on Thu Mar  2 15:15:09 2017.
#
...
project = 'Shelter-database'
copyright = '2017, Netherlands Red Cross'
author = 'Aron Gergely'
...
#
html_title = 'Shelter-database Development API Documentation'
...
htmlhelp_basename = 'Shelter-databasedoc'
...
latex_documents = [
    (master_doc, 'Shelter-database.tex', 'Shelter-database Documentation',
     'Aron Gergely', 'manual'),
]
...
man_pages = [
    (master_doc, 'shelter-database', 'Shelter-database Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Shelter-database', 'Shelter-database Documentation',
     author, 'Shelter-database', 'One line description of project.',
     'Miscellaneous'),
]
