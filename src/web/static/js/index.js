...
$('#searchinput').keyup(function(e){ 
	e.preventDefault();
	if (e.keyCode == 13) {
		window.location.href = "dashboard#zone=&crisis=&climate=&time=&country=&query=" + $('#searchinput').val() + "&topography=&map=";
	}
});
...
$('div[data-href*=\\#]').on('click', function(event){     
    event.preventDefault();
    $root.animate({scrollTop:$(this.dataset.href).offset().top}, 500);
});
